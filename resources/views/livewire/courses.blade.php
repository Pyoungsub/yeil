<div class="mt-12 max-w-5xl mx-auto">
    <div class="grid gap-8">
        ...
        <div class="py-6 px-4 sm:p-6 md:py-10 md:px-8 bg-white border rounded-lg shadow-lg">
            <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                <div class="relative p-3 col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
                    <h1 class="mt-1 text-lg font-semibold text-white sm:text-slate-900 md:text-2xl dark:sm:text-white">연기</h1>
                    <p class="text-sm leading-4 font-medium text-white sm:text-slate-500 dark:sm:text-slate-400">2층 연습실</p>
                </div>
                <div class="grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0">
                    <a href="https://www.yeilactor.co.kr/" class="sm:col-span-4">
                        <div class="relative w-full h-60 bg-cover bg-center bg-no-repeat rounded-lg sm:h-52 sm:col-span-2 lg:col-span-full" style="background-image:url({{ asset('storage/lessons/KakaoTalk_20250331_165543188_01.png') }}" loading="lazy">
                            <h1 class="block sm:hidden absolute top-4 left-0 text-2xl font-bold bg-black/30 text-white rounded-sm px-1">연기</h1>
                        </div>
                    </a>
                    <div class="relative hidden w-full h-52 bg-cover bg-center bg-no-repeat rounded-lg sm:block sm:col-span-2 md:col-span-1 lg:row-start-2 lg:col-span-2 lg:h-32" style="background-image:url({{ asset('storage/lessons/KakaoTalk_20250331_165543188.jpg') }}" loading="lazy"></div>
                    <div class="relative hidden w-full h-52 bg-cover bg-center bg-no-repeat rounded-lg md:block lg:row-start-2 lg:col-span-2 lg:h-32" style="background-image:url({{ asset('storage/lessons/KakaoTalk_20250331_165543188_02.jpg') }}" loading="lazy"></div>
                </div>
                <dl class="mt-4 text-xs font-medium flex items-center row-start-2 sm:mt-1 sm:row-start-3 md:mt-2.5 lg:row-start-2">
                    <dt class="sr-only">Reviews</dt>
                    <dd class="text-indigo-600 flex items-center dark:text-indigo-400">
                ...
                <div class="mt-4 col-start-1 row-start-3 self-center sm:mt-0 sm:col-start-2 sm:row-start-2 sm:row-span-2 lg:mt-6 lg:col-start-1 lg:row-start-3 lg:row-end-4">
                    <a href="https://www.yeilactor.co.kr/" class="bg-indigo-600 text-white text-sm leading-6 font-medium py-2 px-3 rounded-lg">연기 더 알아보기</a>
                </div>
            </div>
        </div>
    </div>
